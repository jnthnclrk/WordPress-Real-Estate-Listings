...
function rel_register_taxonomies () {
    ...
    $rel_taxonomy -> make ( 'Email Campaign Segment', 'Email Campaign Segments', 'email-campaign-segment', 'listings' );
    ...
    $rel_taxonomy -> make ( 'Amenities', 'Amenities', 'amenity', 'listings' );
