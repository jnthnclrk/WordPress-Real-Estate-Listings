...
function rel_inner_custom_box( $post ) {
	...
	echo '<label for="rel_price_sale">Sale Price:</label> <input type="text" id="rel_price_sale" name="rel_price_sale" value="'.esc_attr($rel_price_sale).'" /><span>USD</span><br>';
	$rel_price_long_term = get_post_meta( $post->ID, 'rel_price_long_term', true );
	echo '<label for="rel_price_long_term">Long Term:</label> <input type="text" id="rel_price_long_term" name="rel_price_long_term" value="'.esc_attr($rel_price_long_term).'" /><span>USD per month</span><br>';
	$rel_price_short_term = get_post_meta( $post->ID, 'rel_price_short_term', true );
	echo '<label for="rel_price_short_term">Short Term:</label> <input type="text" id="rel_price_short_term" name="rel_price_short_term" value="'.esc_attr($rel_price_short_term).'" /><span>USD per day</span><br>';
}
